...
This is the test note of 1602 LCD 3.3V with I2C adater and Arduino Uno. You may need a [library](Library/) for the I2C adapter.
...
- [LCD 1602 3.3V Blue](https://www.trademe.co.nz/electronics-photography/other-electronics/electronic-components/other/listing-2658818234.htm?rsqid=e33564eb5b4f4f9f98271cb078373892-001)
...
## Connections
- Connect SDA, SCL, VCC(3.3V on Arduino board), GND pins of I2C Adapter to the same each pin of Arduino board
